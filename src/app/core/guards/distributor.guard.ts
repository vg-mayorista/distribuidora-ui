...
/**
 * Bloquea el acceso a rutas exclusivas del distribuidor.
 * - Sin sesión             → /login?returnUrl=<intentado>
 * - Sesión sin distribuidor → home del rol
 */
export const distributorGuard: CanActivateFn = (_route: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
