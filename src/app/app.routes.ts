...
export const routes: Routes = [
  ...
  { path: 'register', component: RegisterComponent },
  {
    ...
    children: [
      ...
      // `/productos` sección principal de catálogo de productos con stock (requiere login de cliente)
      { path: 'productos', canActivate: [customerGuard], component: StockDisponibleComponent },
      {
        path: 'cliente',
        canActivate: [customerGuard],
        children: [
          { path: '', redirectTo: 'productos', pathMatch: 'full' },
          { path: 'productos', component: StockDisponibleComponent },
          { path: 'catalogo', redirectTo: '/productos', pathMatch: 'full' },
          { path: 'stock-disponible', redirectTo: '/productos', pathMatch: 'full' },
          { path: 'carrito', component: CarritoStockComponent },
          { path: 'carrito-stock', redirectTo: '/cliente/carrito', pathMatch: 'full' },
          { path: 'confirmar', component: ConfirmarComponent, data: { mode: 'stock' } },
          { path: 'confirmar-stock', redirectTo: '/cliente/confirmar', pathMatch: 'full' },
